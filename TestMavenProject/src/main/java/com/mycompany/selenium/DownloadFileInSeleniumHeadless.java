...
public class DownloadFileInSeleniumHeadless {
...
//			WebElement downloadZipButton = wait
//					.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#submit-download-list")));
