...
import com.mycompany.thread.ThreadExecutorWithFuture.ProcessMessageTask;

public class ThreadExcecutorActualLogic {
...
//		ExecutorService mainExecutor = Executors.newSingleThreadExecutor();
		try {
			HttpURLConnection httpUrlConnection = (HttpURLConnection) new URL("https://www.google.com/")
					.openConnection();
