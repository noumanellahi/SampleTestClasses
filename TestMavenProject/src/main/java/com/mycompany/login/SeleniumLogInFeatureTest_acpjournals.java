...
public class SeleniumLogInFeatureTest_acpjournals {
	public static void main(String[] args) {
		String url1 = "https://www.acpjournals.org/action/ssostart?redirectUri=%2Flatest%2Faim";
		String url2 = "https://www.acpjournals.org/doi/pdf/10.7326/M20-7577";

		String emailInputTag = "#login";
		String email = "Clarivate";
		String passwordInputTag = "#password";
		String password = "annals";
		String logInButtonTag = "#pb-page-content > div > div.container > div > main > div > div > div > div:nth-child(2) > div > form > div.submit-section > input";
...
//		options.addArguments("--headless");
		...
		try {
			...
			URL webURL = new URL(URLDecoder.decode("https://www.acpjournals.org/doi/pdf/10.7326/M20-7577", "UTF-8"));
