...
public class FileNameLogicNew {
	...
	public static String getFileName(Long masterId, String description, List<String> generatedFileNamesList,
			String stringURL, HttpURLConnection httpUrlConnection, String userPreference) {
	 ...
	 * @return
	 */
	public static String getUniquePartOfURL(List<String> generatedFileNamesList, String stringURL) {
